...
<body>
<h4>Solicitacao de Visita a Imóvel</h4>

<p>O visitante <?php echo $nome ?> agendou uma visita ao imóvel de código <?php $id_imovel?>.</p>
<p>A visita foi agendada para o dia <?php echo dataMySQL_to_dataBr($data) ?> no horário de <?php echo $hora ?> hs.</p>
